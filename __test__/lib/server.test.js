...
describe('products server testing', ()=>{
  ...
  it('should response with 500 on the invalid route', ()=>{
    let empty = {};
...
///////////////////categories\\\\\\\\\\\\\\
describe('categories server testing', ()=>{
  it('check if can post', ()=>{
    const obj= { name:'wow', display_name:'moka', description:'this is good'};
    return mockRequest
  ...
  it('check if can put', ()=>{
    const obj= {name:'wow', display_name:'moka', description:'this is good'};
    const obj2 = { name:'wwwww', display_name:'yyyyy', description:'ttttttt'};
    let id;
    return mockRequest
      .post('/api/v1/categories')
      .send(obj)
